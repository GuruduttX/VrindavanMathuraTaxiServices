...
const AirportTripFilter = ({ filter, onChange }: any) => {
  ...
  return (
    ...
    <div className="w-full bg-white rounded-2xl overflow-visible shadow-sm relative p-5">
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-13 items-center px-3">
        ...
        <div className="col-span-4 relative">
          ...
          >
            ...
            <h2 className="text-4xl font-bold text-slate-900">{filter.from}</h2>
          </div>
        ...
        <div className="col-span-4 relative">
          ...
          >
            <p className="text-sm text-slate-500">From</p>
            <h2 className="text-4xl font-bold text-slate-900">{filter.to}</h2>
          </div>
