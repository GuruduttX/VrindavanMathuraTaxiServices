...
export default function ProductCard({ car, onClick }: { car: Car, onClick: any }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-sky-100 p-5 flex flex-col md:flex-row lg:flex-row justify-between items-center hover:shadow-md transition">
      ...
      {/* RIGHT */}
      <div className="flex flex-row gap-10 md:flex-col lg:flex-col text-right">
        <div>
